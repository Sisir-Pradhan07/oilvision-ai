      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-6 border-t border-slate-800 pt-8 md:flex-row">
          ...
          <button
            onClick={scrollToTop}
            type="button"
            className="flex items-center gap-2 rounded-full border border-cyan-500 bg-cyan-500/10 px-5 py-3 text-cyan-300 transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-cyan-500 hover:text-white"
          >
            <FaArrowUp />
            Back to Top
          </button>
