...
import ModelFitMeter from "./ModelFitMeter";
...
async function handleShare() {
  ...
  const shareText = `OilVision AI Prediction

Indian Oil Price: ₹${predictedPrice}/barrel
Model: ${result.model}
Model Fit (R² Score): 0.9859
Brent Oil: $${inputs?.Brent_Oil_Price_US_b}
...
Generated by OilVision AI`;
  ...
  try {
    ...
    if (error.name !== "AbortError") {
      toast.error("Unable to share prediction.");
    }
  }
}
  return (
  ...
  {!loading && result && (
    <button
      type="button"
      onClick={handleShare}
      className="mt-1 flex shrink-0 items-center gap-2 rounded-xl border border-slate-700 bg-slate-900/60 px-4 py-2.5 text-sm font-medium text-slate-300 backdrop-blur transition-all duration-300 hover:border-blue-500/50 hover:bg-blue-500/10 hover:text-white"
...
>
  ...
  <span className="ml-1 bg-gradient-to-r from-cyan-300 via-blue-400 to-violet-400 bg-clip-text text-transparent">
    AI
  </span>
</h2>
